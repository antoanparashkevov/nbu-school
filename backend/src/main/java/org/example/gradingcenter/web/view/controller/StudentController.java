...
public class StudentController {
    ...
    public String showEditStudentForm(Model model, @PathVariable Long id) {
        ...
        model.addAttribute("subjects", MapperUtil.mapList(subjectService.getSubjects(student.getGrade().getName(), student.getSchool().getId()), MapperUtil::dtoToViewModel));
        model.addAttribute("teachers", MapperUtil.mapList(teacherService.getTeachers(), MapperUtil::dtoToViewModel));
        model.addAttribute("marks", MapperUtil.mapList(markService.getMarks(id), MapperUtil::dtoToViewModel));
